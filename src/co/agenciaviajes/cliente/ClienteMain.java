...
public class ClienteMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(" Región = "
                    + otroPaquete.getNombre() + " " + otroPaquete.getComponentPrecio() + " Pesos");
            System.out.println(" Pais 1 = "
                    + otroPais1.getNombre() + " " + otroPais1.getComponentPrecio() + " Pesos");
            System.out.println(" Pais 2 = "
                    + otroPais2.getNombre() + " " + otroPais2.getComponentPrecio() + " Pesos");
            System.out.println(" Pais 3 = "
                    + otroPais3.getNombre() + " " + otroPais3.getComponentPrecio() + " Pesos");
